...
ActiveRecord::Schema.define(version: 20130925152602) do
  ...
  add_index "aoas", ["name"], name: "name", unique: true, using: :btree
  ...
  add_index "cms_cmscategory", ["parentCategory"], name: "index1", using: :btree
  ...
  add_index "cms_cmsfile", ["accessCount"], name: "index1", using: :btree
  ...
  add_index "counties", ["state"], name: "state", using: :btree
  ...
  add_index "crs2_additional_expenses_item", ["expense_id"], name: "fk_additional_expenses_item_expense_id", using: :btree
  add_index "crs2_additional_expenses_item", ["registrant_type_id", "expense_id"], name: "unique_registrant_type_expense", unique: true, using: :btree
  add_index "crs2_additional_expenses_item", ["registrant_type_id"], name: "fk_additional_expenses_item_registrant_type_id", using: :btree
  ...
  add_index "crs2_additional_info_item", ["conference_id"], name: "fk_additional_info_item_conference_id", using: :btree
  ...
  add_index "crs2_answer", ["question_usage_id"], name: "fk_answer_question_usage_id", using: :btree
  add_index "crs2_answer", ["registrant_id", "question_usage_id"], name: "unique_registrant_question_usage", unique: true, using: :btree
  add_index "crs2_answer", ["registrant_id"], name: "fk_answer_registrant_id", using: :btree
  ...
  add_index "crs2_conference", ["creator_id"], name: "fk_conference_creator_id", using: :btree
  add_index "crs2_conference", ["name"], name: "unique_name", unique: true, using: :btree
  add_index "crs2_conference", ["url_base_id"], name: "fk_conference_url_base_id", using: :btree
  ...
  add_index "crs2_configuration", ["default_url_base_id"], name: "fk_configuration_default_url_base_id", using: :btree
  ...
  add_index "crs2_custom_questions_item", ["question_id"], name: "fk_custom_questions_item_question_id", using: :btree
  add_index "crs2_custom_questions_item", ["registrant_type_id", "question_id"], name: "unique_registrant_type_question", unique: true, using: :btree
  add_index "crs2_custom_questions_item", ["registrant_type_id"], name: "fk_custom_questions_item_registrant_type_id", using: :btree
  ...
  add_index "crs2_expense", ["conference_id"], name: "fk_expense_conference_id", using: :btree
  ...
  add_index "crs2_expense_selection", ["expense_usage_id"], name: "fk_expense_selection_expense_usage_id", using: :btree
  add_index "crs2_expense_selection", ["registrant_id", "expense_usage_id"], name: "unique_registrant_expense_usage", unique: true, using: :btree
  add_index "crs2_expense_selection", ["registrant_id"], name: "fk_expense_selection_registrant_id", using: :btree
  ...
  add_index "crs2_module_usage", ["conference_id"], name: "fk_module_usage_conference_id", using: :btree
  ...
  add_index "crs2_phone_numbers", ["person_id"], name: "index_crs2_phone_numbers_on_person_id", using: :btree
  ...
  add_index "crs2_profile", ["crs_person_id"], name: "fk_profile_crs_person_id", using: :btree
  add_index "crs2_profile", ["crs_person_id"], name: "unique_crs_person", unique: true, using: :btree
  add_index "crs2_profile", ["ministry_person_id"], name: "fk_profile_ministry_person_id", using: :btree
  add_index "crs2_profile", ["ministry_person_id"], name: "unique_ministry_person", unique: true, using: :btree
  add_index "crs2_profile", ["user_id"], name: "fk_profile_user_id", using: :btree
  add_index "crs2_profile", ["user_id"], name: "unique_user", unique: true, using: :btree
  ...
  add_index "crs2_profile_question", ["registrant_type_id"], name: "fk_profile_question_registrant_type_id", using: :btree
  ...
  add_index "crs2_question", ["conference_id"], name: "fk_question_conference_id", using: :btree
  add_index "crs2_question", ["name", "conference_id"], name: "unique_name_conference", unique: true, using: :btree
  ...
  add_index "crs2_question_option", ["option_question_id", "name"], name: "unique_option_question_name", unique: true, using: :btree
  add_index "crs2_question_option", ["option_question_id", "value"], name: "unique_option_question_value", unique: true, using: :btree
  add_index "crs2_question_option", ["option_question_id"], name: "fk_question_option_option_question_id", using: :btree
  ...
  add_index "crs2_registrant", ["cancelled_by_id"], name: "fk_registrant_cancelled_by_id", using: :btree
  add_index "crs2_registrant", ["profile_id", "registrant_type_id"], name: "unique_profile_registrant_type", unique: true, using: :btree
  add_index "crs2_registrant", ["profile_id"], name: "fk_registrant_profile_id", using: :btree
  add_index "crs2_registrant", ["registrant_type_before_cancellation_id"], name: "fk_registrant_registrant_type_before_cancellation_id", using: :btree
  add_index "crs2_registrant", ["registrant_type_id"], name: "fk_registrant_registrant_type_id", using: :btree
  add_index "crs2_registrant", ["registration_before_cancellation_id"], name: "fk_registrant_registration_before_cancellation_id", using: :btree
  add_index "crs2_registrant", ["registration_id"], name: "fk_registrant_registration_id", using: :btree
  add_index "crs2_registrant", ["status"], name: "index_crs2_registrant_on_status", using: :btree
  ...
  add_index "crs2_registrant_type", ["conference_id"], name: "fk_registrant_type_conference_id", using: :btree
  ...
  add_index "crs2_registration", ["creator_id"], name: "fk_registration_creator_id", using: :btree
  ...
  add_index "crs2_transaction", ["authorizer_id"], name: "fk_transaction_authorizer_id", using: :btree
  add_index "crs2_transaction", ["charge_cancellation_id"], name: "fk_transaction_charge_cancellation_id", using: :btree
  add_index "crs2_transaction", ["conference_id"], name: "fk_transaction_conference_id", using: :btree
  add_index "crs2_transaction", ["expense_selection_id"], name: "fk_transaction_expense_selection_id", using: :btree
  add_index "crs2_transaction", ["indicated_verifier_id"], name: "fk_transaction_indicated_verifier_id", using: :btree
  add_index "crs2_transaction", ["paid_by_id"], name: "fk_transaction_paid_by_id", using: :btree
  add_index "crs2_transaction", ["payment_cancellation_id"], name: "fk_transaction_payment_cancellation_id", using: :btree
  add_index "crs2_transaction", ["registrant_id"], name: "fk_transaction_registrant_id", using: :btree
  add_index "crs2_transaction", ["registration_id"], name: "fk_transaction_registration_id", using: :btree
  add_index "crs2_transaction", ["scholarship_charge_id"], name: "fk_transaction_scholarship_charge_id", using: :btree
  add_index "crs2_transaction", ["user_id"], name: "fk_transaction_user_id", using: :btree
  add_index "crs2_transaction", ["verified_by_id"], name: "fk_transaction_verified_by_id", using: :btree
  ...
  add_index "crs2_user_role", ["conference_id"], name: "fk_user_rule_conference_id", using: :btree
  add_index "crs2_user_role", ["user_id"], name: "fk_user_rule_user_id", using: :btree
  ...
  add_index "crs_answer", ["fk_QuestionID", "fk_RegistrationID"], name: "fk_QuestionID", using: :btree
  add_index "crs_answer", ["fk_RegistrationID"], name: "fk_RegistrationID", using: :btree
  ...
  add_index "crs_childregistration", ["fk_RegistrationID"], name: "fk_RegistrationID", using: :btree
  ...
  add_index "crs_customitem", ["fk_ConferenceID"], name: "fk_ConferenceID", using: :btree
  ...
  add_index "crs_merchandise", ["fk_ConferenceID", "fk_RegistrationTypeID"], name: "fk_ConferenceID", using: :btree
  ...
  add_index "crs_payment", ["fk_RegistrationID"], name: "fk_RegistrationID", using: :btree
  ...
  add_index "crs_question", ["fk_ConferenceID", "fk_RegistrationTypeID"], name: "fk_ConferenceID", using: :btree
  add_index "crs_question", ["fk_QuestionTextID"], name: "fk_QuestionTextID", using: :btree
  ...
  add_index "crs_registration", ["fk_ConferenceID"], name: "fk_ConferenceID", using: :btree
  add_index "crs_registration", ["fk_PersonID"], name: "fk_PersonID", using: :btree
  add_index "crs_registration", ["fk_RegistrationTypeID"], name: "fk_RegistrationTypeID", using: :btree
  ...
  add_index "crs_registrationtype", ["fk_ConferenceID"], name: "fk_ConferenceID", using: :btree
  ...
  create_table "deleted_people", primary_key: "personID", force: true do |t|
  ...
  add_index "deleted_people", ["accountNo"], name: "accountNo_ministry_Person", using: :btree
  add_index "deleted_people", ["campus"], name: "campus", using: :btree
  add_index "deleted_people", ["fb_uid"], name: "index_ministry_person_on_fb_uid", using: :btree
  add_index "deleted_people", ["firstName", "lastName"], name: "firstName_lastName", using: :btree
  add_index "deleted_people", ["fk_ssmUserId"], name: "fk_ssmUserId", using: :btree
  add_index "deleted_people", ["lastName"], name: "lastname_ministry_Person", using: :btree
  add_index "deleted_people", ["region"], name: "region_ministry_Person", using: :btree
  add_index "deleted_people", ["siebel_contact_id"], name: "index_ministry_person_on_siebel_contact_id", using: :btree
  ...
  add_index "hr_ms_payment", ["fk_WsnApplicationID"], name: "fk_WsnApplicationID", using: :btree
  ...
  add_index "hr_review360_review360", ["fk_ReviewSessionID"], name: "index1", using: :btree
  ...
  add_index "hr_review360_review360light", ["fk_ReviewSessionLightID"], name: "index1", using: :btree
  ...
  add_index "hr_si_applications", ["apply_id"], name: "apply_id", using: :btree
  add_index "hr_si_applications", ["fk_personID"], name: "fk_PersonID", using: :btree
  add_index "hr_si_applications", ["locationA"], name: "locationA", using: :btree
  add_index "hr_si_applications", ["locationB"], name: "locationB", using: :btree
  add_index "hr_si_applications", ["locationC"], name: "locationC", using: :btree
  add_index "hr_si_applications", ["oldApplicationID"], name: "oldApplicationID", using: :btree
  add_index "hr_si_applications", ["siYear"], name: "siYear", using: :btree

  create_table "hr_si_payment_deprecated", primary_key: "paymentID", force: true do |t|
    t.datetime "paymentDate"
    t.float    "debit"
    t.float    "credit"
    t.string   "type",             limit: 80
  ...
  add_index "hr_si_payment_deprecated", ["fk_ApplicationID"], name: "fk_ApplicationID", using: :btree
  ...
  create_table "hr_si_reference_deprecated", primary_key: "referenceID", force: true do |t|
  ...
  add_index "hr_si_reference_deprecated", ["fk_SIApplicationID"], name: "fk_SIApplicationID", using: :btree
  add_index "hr_si_reference_deprecated", ["oldReferenceID"], name: "oldReferenceID", using: :btree
  add_index "hr_si_reference_deprecated", ["oldSIApplicationID"], name: "IX_hr_si_Reference_2006", using: :btree
  add_index "hr_si_reference_deprecated", ["siYear"], name: "siYear", using: :btree
  ...
  add_index "mail_groups", ["group_id"], name: "index_mail_groups_on_group_id", using: :btree
  add_index "mail_groups", ["user_id"], name: "index_mail_groups_on_user_id", using: :btree
  ...
  add_index "mail_members", ["group_id"], name: "index_mail_members_on_group_id", using: :btree
  ...
  add_index "mail_users", ["guid"], name: "guid", using: :btree
  ...
  add_index "merge_audits", ["merge_looser_id", "merge_looser_type"], name: "merge_looser", using: :btree
  ...
  create_table "ministry_statistic_before_pg_merge", primary_key: "StatisticID", force: true do |t|
    t.date     "periodBegin"
    t.date     "periodEnd"
    t.integer  "exposures"
    t.integer  "exposuresViaMedia"
  ...
  add_index "ministry_statistic_before_pg_merge", ["fk_Activity"], name: "index1", using: :btree
  add_index "ministry_statistic_before_pg_merge", ["periodBegin"], name: "index2", using: :btree
  add_index "ministry_statistic_before_pg_merge", ["periodEnd", "fk_Activity", "peopleGroup"], name: "activityWeekPeopleGroup", unique: true, using: :btree
  add_index "ministry_statistic_before_pg_merge", ["periodEnd"], name: "index3", using: :btree
  ...
  add_index "mpd_events", ["project_id"], name: "project_id", using: :btree
  ...
  add_index "old_wsn_sp_wsnapplication", ["applAccountNo"], name: "index10", using: :btree
  add_index "old_wsn_sp_wsnapplication", ["fk_childOf"], name: "index3", using: :btree
  add_index "old_wsn_sp_wsnapplication", ["fk_isMember"], name: "index1", using: :btree
  add_index "old_wsn_sp_wsnapplication", ["fk_personID"], name: "fk_personID", using: :btree
  add_index "old_wsn_sp_wsnapplication", ["fk_wsnSpouse"], name: "index2", using: :btree
  add_index "old_wsn_sp_wsnapplication", ["region"], name: "index11", using: :btree
  add_index "old_wsn_sp_wsnapplication", ["status"], name: "index8", using: :btree
  add_index "old_wsn_sp_wsnapplication", ["wsnYear"], name: "index9", using: :btree
  ...
  add_index "profile_pictures", ["person_id"], name: "index_profile_pictures_on_person_id", using: :btree
  ...
  add_index "rideshare_ride", ["driver_ride_id"], name: "fk_driverID", using: :btree
  add_index "rideshare_ride", ["event_id"], name: "fk_eventID", using: :btree
  add_index "rideshare_ride", ["person_id"], name: "fk_personID", using: :btree
  ...
  add_index "si_answer_sheet_question_sheets", ["answer_sheet_id"], name: "index_si_answer_sheet_question_sheets_on_answer_sheet_id", using: :btree
  add_index "si_answer_sheet_question_sheets", ["question_sheet_id"], name: "question_sheet_id", using: :btree
  ...
  add_index "si_answers", ["answer_sheet_id"], name: "index_si_answers_on_answer_sheet_id", using: :btree
  add_index "si_answers", ["answer_sheet_question_sheet_id"], name: "answer_sheet_id", using: :btree
  add_index "si_answers", ["answer_sheet_question_sheet_id"], name: "index_si_answers_on_answer_sheet_question_sheet_id", using: :btree
  add_index "si_answers", ["question_id"], name: "question_id", using: :btree
  add_index "si_answers", ["short_value"], name: "index_si_answers_on_short_value", using: :btree
  ...
  add_index "si_applies", ["applicant_id"], name: "applicant_id", using: :btree
  add_index "si_applies", ["sleeve_id"], name: "sleeve_id", using: :btree
  add_index "si_applies", ["status"], name: "index_si_applies_on_status", using: :btree
  add_index "si_applies", ["submitted_at"], name: "index_si_applies_on_submitted_at", using: :btree

  create_table "si_apply_sheets_deprecated", force: true do |t|
    t.integer "apply_id",        null: false
    t.integer "sleeve_sheet_id", null: false
    t.integer "answer_sheet_id", null: false
  end

  add_index "si_apply_sheets_deprecated", ["apply_id"], name: "apply_id", using: :btree
  ...
  add_index "si_page_elements", ["page_id"], name: "index_si_page_elements_on_page_id", using: :btree
  ...
  add_index "si_references", ["access_key"], name: "index_si_character_references_on_token", using: :btree
  add_index "si_references", ["applicant_answer_sheet_id"], name: "apply_id", using: :btree
  ...
  create_table "si_sleeve_sheets_deprecated", force: true do |t|
  ...
  create_table "si_sleeves_deprecated", force: true do |t|
    t.string  "title",      limit: 60,                                       null: false
    t.string  "slug",       limit: 36
    t.decimal "fee_amount",            precision: 9, scale: 2, default: 0.0
  end

  add_index "si_sleeves_deprecated", ["slug"], name: "index_si_sleeves_on_slug", unique: true, using: :btree
  ...
  add_index "si_users", ["ssm_id"], name: "ssm_id", using: :btree
  ...
  add_index "sitrack_children", ["person_id"], name: "fk_personID", using: :btree
  ...
  add_index "sitrack_enum_values", ["sitrack_column_id"], name: "index_sitrack_enum_values_on_sitrack_column_id", using: :btree
  ...
  add_index "sitrack_feeds", ["lastRun"], name: "IX_sitrack_Feeds", using: :btree
  ...
  add_index "sitrack_mpd", ["application_id"], name: "fk_applicationID", using: :btree
  add_index "sitrack_mpd", ["person_id"], name: "fk_personID", using: :btree
  ...
  add_index "sitrack_queries", ["owner"], name: "owner", using: :btree
  ...
  add_index "sitrack_saved_criteria", ["owner"], name: "owner_sitrack_SavedCriteria", using: :btree
  add_index "sitrack_saved_criteria", ["saved"], name: "index_sitrack_saved_criteria_on_saved", using: :btree
  ...
  add_index "sitrack_session_values", ["attrib"], name: "index_sitrack_session_values_on_attrib", using: :btree
  add_index "sitrack_session_values", ["sitrack_session_id"], name: "sitrack_session_id", using: :btree
  ...
  add_index "sitrack_sessions", ["sitrack_user_id"], name: "index_sitrack_sessions_on_sitrack_user_id", using: :btree
  ...
  add_index "sitrack_tracking", ["asgTeam"], name: "asgTeam", using: :btree
  add_index "sitrack_tracking", ["caringRegion"], name: "caringRegion", using: :btree
  add_index "sitrack_tracking", ["internType"], name: "interntype", using: :btree
  add_index "sitrack_tracking", ["person_id"], name: "fk_personID", using: :btree
  add_index "sitrack_tracking", ["status"], name: "status", using: :btree
  add_index "sitrack_tracking", ["teamLeader"], name: "teamLeader", using: :btree
  add_index "sitrack_tracking", ["tenure"], name: "tenure", using: :btree
  ...
  add_index "sitrack_users", ["ssm_id"], name: "index_sitrack_users_on_ssm_id", using: :btree
  ...
  add_index "sitrack_view_columns", ["sitrack_column_id"], name: "sitrack_column_id", using: :btree
  add_index "sitrack_view_columns", ["sitrack_view_id"], name: "sitrack_view_id", using: :btree
  ...
  add_index "sitrack_views", ["sitrack_user_id"], name: "uuid", using: :btree
  ...
  add_index "sp_applications", ["project_id"], name: "project_id", using: :btree
  ...
  add_index "staffsite_staffsitepref", ["fk_StaffSiteProfile"], name: "index1", using: :btree
  add_index "staffsite_staffsitepref", ["name"], name: "index2", using: :btree
